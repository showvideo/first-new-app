...
<?php if(isset($visitime1)) { ?> <div style="display:inline-block;border:ridge;width:367px;height:579px;position:relative;">
   <?php
    ...
    ?>
    <h3 style="padding-left:20px;font-size:30px;"><?php echo $name."様"; ?></h3></br>
    <a style="margin-left:40px;font-size:20px;">来所時間</a></br>
    <input type="text" value="<?php echo substr($visit, 0, 2); ?>" style="width:44px;height:55px;margin-left:60px;color:black;font-weight:bold;">:
