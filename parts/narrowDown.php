...
<div style="display:inline-block;width:250px;vertical-align:top;margin-left:6px;">
    ...
    <div style="width:200px;height:115px;border:ridge;margin:0;">
        <p style="padding-left:10px;">時間を入力してください</p>
        <input type="text" name="search_exit" style="width:100px;height:20px;margin-left:15px;">
    ...
    <div style="width:200px;border:ridge;margin:0;">
        ...
        <input type="submit" value="絞り込み" style="margin-left:65px;margin-top:20px;margin-bottom:10px;">
       
    </div>

    <div style="border:ridge;margin-top:20px;width:65px;padding:4px;">特記事項</div>
    <div style="width:200px;border:ridge;margin:0;"></br>
        <input type="radio" name="bath1" value="yes" style="margin-left:30px;"> はい
