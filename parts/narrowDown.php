...
<div style="display:inline-block;width:250px;vertical-align:top;margin-left:6px;">
    ...
    <div style="width:200px;height:115px;border:ridge;margin:0;">
        ...
        <input type="text" name="search_visit" style="width:100px;height:20px;margin-left:20px;"></br>
        <input type="submit" name="vsearch_submit" value="絞り込み" style="margin-right:auto;margin-left:auto;">
    </div>
