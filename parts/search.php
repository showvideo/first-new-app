...
<div style="display:inline-block;border:ridge;width:400px;vertical-align:top;margin-left:6px;padding-left:20px;">
    ...
    <h4>退所</h4>
      ...
      <h4>バイタル</h4>
        <a style="margin-left:20px;">最高血圧(mmhg)</a><input type="text" name="vital1" style="width:40px;height:50px;margin-left:20px;">～<input type="text" name="vital1" style="width:40px;height:50px;"></br>
