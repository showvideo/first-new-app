...
<div style="display:inline-block;border:ridge;width:400px;vertical-align:top;margin-left:6px;padding-left:20px;">
    ...
    <h4>退所</h4>
      ...
      <h4>バイタル</h4>
        最高血圧(mmhg)<input type="text" name="vital1" style="width:40px;height:50px;margin-left:20px;">～<input type="text" name="vital1" style="width:40px;height:50px;"></br>
      
        最低血圧(mmhg)<input type="text" name="vital2" style="width:40px;height:50px;margin-left:20px;">～<input type="text" name="vital2" style="width:40px;height:50px;">
        
        脈拍(拍/分)<input type="text" name="vital3" style="width:40px;height:50px;margin-left:20px;">～<input type="text" name="vital3" style="width:40px;height:50px;">
